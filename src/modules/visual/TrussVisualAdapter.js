...
(function () {
  ...
  const GEOMETRY = ROOT.TrussGeometry;
  ...
  function normalizeCellMeters(value) {
    return GEOMETRY.normalizeCellMeters(value);
  }
  ...
  function itemBoundsCells(item, spec, cellMeters) {
    return GEOMETRY.itemBoundsCells(item, spec, cellMeters);
  }

  function itemBoundsMeters(item, spec, cellMeters) {
    return GEOMETRY.itemBoundsMeters(item, spec, cellMeters);
  }
